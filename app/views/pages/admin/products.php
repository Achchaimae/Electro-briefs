            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                <section>
                    <div class="flex justify-between mx-4">
                        ...
                        <button class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 "><a href="<?= URLROOT; ?>/products/add">Add</a></button>
                    </div>
                                ...
                                <table class="table text-gray-400 border-separate space-y-6 text-sm">
                                    <thead class="bg-gray-800 text-gray-500">
                                        <tr>
                                            ...
                                            <th class="p-3 text-left">code Barre</th>
                                            <th class="p-3 ">Buy Price</th>
                                            <th class="p-3 ">Final price</th>
                                            <th class="p-3 ">OffrePrice</th>
