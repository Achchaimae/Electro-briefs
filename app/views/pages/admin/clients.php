    ...
    <div x-data="setup()" :class="{ 'dark': isDark }">
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                <span class="ml-2 text-gray-500 font-bold tracking-wide truncate ">Clients</span>
                <!-- Client Table -->
                <div>
                    <div class="mt-4 mx-4">
                                            ...
                                            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center text-sm">
                                                        ...
                                                        <div>
                                                            <p class="font-semibold"> <?php echo $client->nom; ?> <?php echo  $client->prenom; ?></p>
                                                            <p class="text-xs text-gray-600 dark:text-gray-400">10x Developer</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-3 text-sm"><?php echo $client->telephone ?></td>
                                                <td class="px-4 py-3 text-xs">
                                                    <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"><?php echo $client->email ?></span>
                                                </td>
                                                <td class="px-4 py-3 text-sm"><?php echo $client->adresse ?></td>
                                            </tr>
                                        <?php endforeach; ?>
